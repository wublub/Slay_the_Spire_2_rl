...
如果这是你第一次把当前仓库推到 GitHub，推荐按这个顺序：

1. 在 GitHub 网页新建一个空仓库，例如 `Slay_the_Spire_2_rl-main`
2. 在本地仓库根目录打开 PowerShell
3. 依次执行：
...
```powershell
git add .
git commit -m "Add training UI and improve bridge UI"
git push
```

如果你更习惯 SSH，把 `origin` 换成：
